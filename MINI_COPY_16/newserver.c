			...
			while(1){
    			...
    			if(option==1){ //ADMIN
    				...
    				while(admin_exit == 0){
	        			...
	        			performAdmin_Task(answer,client_socket,id,&admin_exit);	
	        		}
    			}
    			int br = 0;
